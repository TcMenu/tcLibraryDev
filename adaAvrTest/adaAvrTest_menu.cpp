...
FloatMenuItem menuFlt(&minfoFlt, 0.0, NULL);
const PROGMEM AnyMenuInfo minfoSubPressMe = { "Press me", 5, 0xffff, 0, NO_CALLBACK };
ActionMenuItem menuSubPressMe(&minfoSubPressMe, &menuFlt);
...
BackMenuItem menuBackSub(fnSubRtCall, &menuSubPressMe);
...
BooleanMenuItem menuBool(&minfoBool, false, &menuLge);
const PROGMEM AnalogMenuInfo minfoAnalog = { "Analog", 1, 0xffff, 255, NO_CALLBACK, 0, 1, "Unit" };
AnalogMenuItem menuAnalog(&minfoAnalog, 0, &menuBool);
