...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_Init2Delete(void)
{
...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef HAL_DeInit2Delete(void)
{
...
/**
  ...
  */
uint32_t HAL_GetTickPrio2Delete(void)
{
    return uwTickPrio;
}
...
/**
  ...
  * @retval Status
  */
HAL_StatusTypeDef HAL_SetTickFreq2Delete(HAL_TickFreqTypeDef Freq)
{
...
/**
  ...
  */
HAL_TickFreqTypeDef HAL_GetTickFreq2Delete(void)
{
    return uwTickFreq;
}
