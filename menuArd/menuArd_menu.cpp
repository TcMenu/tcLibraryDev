...
const PROGMEM ConnectorLocalInfo applicationInfo = { "ESP8266 Demo", "01b9cb76-c108-4be3-a133-6159f8f1c9c1" };
...
TextMenuItem menuText(fnTextRtCall, 21, 5, NULL);
const AnalogMenuInfo PROGMEM minfoTenths = { "Tenths", 20, 50, 1000, NO_CALLBACK, 0, 10, "" };
AnalogMenuItem menuTenths(&minfoTenths, 0, &menuText);
RENDERING_CALLBACK_NAME_INVOKE(fnRGBRtCall, rgbAlphaItemRenderFn, "RGB", 46, NO_CALLBACK)
Rgb32MenuItem menuRGB(19, fnRGBRtCall, true, &menuTenths);
RENDERING_CALLBACK_NAME_INVOKE(fnLgeNumRtCall, largeNumItemRenderFn, "Lge Num", 38, NO_CALLBACK)
EditableLargeNumberMenuItem menuLgeNum(fnLgeNumRtCall, 18, 6, 2, false, &menuRGB);
const AnalogMenuInfo PROGMEM minfoVolume = { "Volume", 17, 0xFFFF, 255, NO_CALLBACK, -180, 2, "dB" };
AnalogMenuItem menuVolume(&minfoVolume, 0, &menuLgeNum);
const SubMenuInfo PROGMEM minfoEditable = { "Editable", 16, 0xFFFF, 0, NO_CALLBACK };
RENDERING_CALLBACK_NAME_INVOKE(fnEditableRtCall, backSubItemRenderFn, "Editable", -1, NO_CALLBACK)
BackMenuItem menuBackEditable(fnEditableRtCall, &menuVolume);
SubMenuItem menuEditable(&minfoEditable, &menuBackEditable, NULL);
...
SubMenuItem menuConnectivity(&minfoConnectivity, &menuBackConnectivity, &menuEditable);
