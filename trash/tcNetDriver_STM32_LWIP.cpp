...
namespace tcremote {
    ...
    public:
        ...
        SocketErrCode flush() {
            ...
            if(bytesWeAreWaitingFor > 5000) {
                taskManager.yieldForMicros(millisToMicros(timeOutMillis));
                if(bytesWeAreWaitingFor > 5000) return SOCK_ERR_TIMEOUT;
            }
            ...
            bytesWeAreWaitingFor += writeBufferPos;
            writeBufferPos = 0;
